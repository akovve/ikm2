...
namespace {
struct qt_meta_tag_ZN7SubjectE_t {};
} // unnamed namespace

template <> constexpr inline auto Subject::qt_create_metaobjectdata<qt_meta_tag_ZN7SubjectE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Subject, qt_meta_tag_ZN7SubjectE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Subject::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SubjectE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SubjectE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7SubjectE_t>.metaTypes,
    nullptr
} };
...
void Subject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Subject::*)()>(_a, &Subject::idChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Subject::*)()>(_a, &Subject::nameChanged, 1))
            return;
    }
...
void *Subject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SubjectE_t>.strings))
